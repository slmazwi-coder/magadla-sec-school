	...
	return (
		<div className="py-16 bg-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<h1 className="section-title">About Magadla Senior Secondary School</h1>

				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
					<motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
						<h2 className="text-2xl font-bold text-school-green mb-6">Our Story</h2>
					...
					>
						<img src="/images/Magadla%20choir.jpg" alt="Magadla Choir" className="w-full h-full object-cover" />
					</motion.div>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
						<div className="col-span-1">
							<div className="aspect-square rounded-2xl overflow-hidden border-4 border-white shadow-lg">
								<img
									src="/images/PrinciPal%20Mr%20SS%20Magadla.jpg"
