...
export const About = () => {
	...
	const campusImageUrl = '/images/Magadla choir.jpg';
	const principalImageUrl = '/images/PrinciPal Mr SS Magadla.jpg';
	...
	return (
		<div className="py-12 sm:py-16 bg-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				{/* Page Title */}
				<h1 className="section-title">About Magadla SSS</h1>
									...
									{!campusFailed ? (
										...
										<div className="w-full h-full bg-gradient-to-br from-[#166534] via-[#C8A400] to-[#166534] flex items-center justify-center">
											<div className="text-center text-white/70 px-6">
												...
												<div className="text-sm text-white/60 font-mono">public/images/</div>
											</div>
										</div>
									)}
								</div>
